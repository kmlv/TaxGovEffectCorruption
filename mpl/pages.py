    ...
    def vars_for_template(self):
        ...
        if Constants.one_choice_per_page:
            ...
            return {
                ...
                'image_path': 'global/main_W.png'.format(self.round_number),
                'image_path2': 'global/1.png'.format(self.round_number),'image_basic': 'global/basic.png'.format(self.round_number)
            }
