# Generated by Django 2.2.12 on 2021-04-02 01:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_offered', otree.db.models.CurrencyField(default=0, null=True)),
                ('total_amount_offered', otree.db.models.CurrencyField(default=0, null=True)),
                ('current_endowment', otree.db.models.CurrencyField(default=0, null=True)),
                ('message', otree.db.models.StringField(default='', max_length=10000, null=True)),
                ('offer_accepted', otree.db.models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], null=True)),
                ('complex_mode', otree.db.models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=False, null=True)),
